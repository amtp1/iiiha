"""
Django settings for iiiha project.
...
WSGI_APPLICATION = 'iiiha.wsgi.application'
...
STABLE_DIFF_SECRET_KEY = os.getenv('STABLE_DIFF_SECRET_KEY')
...
CHATGPT_PLUS = os.getenv('CHATGPT_PLUS')
